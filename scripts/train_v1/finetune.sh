...
srun -J debug \
    ...
    torchrun --nproc_per_node=8 \
        ...
        --pretrain_mm_mlp_adapter="/mnt/petrelfs/niujunbo/niujunbo_dev/0630/LLaVA-dev/playground/training/07-01/NativeRes-Qwen2.5-0.5B-Instruct-qwen2_5_vit-pt/checkpoints/projectors/NativeRes-Qwen2.5-0.5B-Instruct-qwen2_5_vit-pt/checkpoint-4360/mm_projector.bin" \
