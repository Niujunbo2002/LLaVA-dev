...
export BASE_RUN_NAME="nativeres-llava-${LLM_VERSION_CLEAN}-qwenvit_2_5-pt-debug"
...
srun -J debug \
    ...
    2>&1 | tee /mnt/petrelfs/niujunbo/zhengyuanhong/NativeResLLaVA/logs/${BASE_RUN_NAME}.log'
