...
export MID_RUN_NAME="llava-next-Qwen2-7B-Instruct-qwenvit-182_182_visual_token-ft"
...
srun -J debug \
    ...
    2>&1 | tee /mnt/petrelfs/niujunbo/zhengyuanhong/NativeResLLaVA/logs/direct_finetune_qwen_a4_v1.5_182_182.log'
