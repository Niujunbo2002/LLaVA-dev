...
export MID_RUN_NAME="llava-next-Qwen2-7B-Instruct-siglip-ft-no-anyres"
...
srun -J debug \
    ...
    2>&1 | tee /mnt/petrelfs/niujunbo/zhengyuanhong/NativeResLLaVA/logs/direct_finetune_siglip_a4_v1.5.log'
