...
export MID_RUN_NAME="llava-next-Qwen2-7B-Instruct-qwenvit-1336_1336_visual_token-ft_v1"
...
srun -J debug \
    ...
    2>&1 | tee /mnt/petrelfs/niujunbo/zhengyuanhong/NativeResLLaVA/logs/direct_finetune_qwen_a4_v1.5_1336_1336.log'
