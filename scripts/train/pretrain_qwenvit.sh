...
srun -J debug \
    ...
    --bf16 True \
    --output_dir /mnt/hwfile/doc_parse/niujunbo/llava/checkpoints/projectors/${BASE_RUN_NAME}_182 \
    --num_train_epochs 1 \
    ...
    2>&1 | tee /mnt/petrelfs/niujunbo/zhengyuanhong/NativeResLLaVA/logs/NativeRes-LLaVA-Next-pt-182.log'
