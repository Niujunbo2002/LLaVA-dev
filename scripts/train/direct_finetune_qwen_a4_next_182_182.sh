...
export MID_RUN_NAME="llava-next-Qwen2-7B-Instruct-qwenvit-182_182_visual_token-ft_v2_2"
export PROMPT_VERSION="qwen_1_5"

export BASE_RUN_NAME="llavanext-${VISION_MODEL_VERSION_CLEAN}-${LLM_VERSION_CLEAN}-mlp2x_gelu-pretrain_blip558k_plain_182"
...
srun -J debug \
    ...
    --data_path=/mnt/petrelfs/niujunbo/doc_parse/lmms-lab/LLaVA-NeXT-Data/llava_next_raw_format/llava_next_raw_format_processed.json \
    --image_folder /mnt/petrelfs/niujunbo/doc_parse/lmms-lab/LLaVA-NeXT-Data/llava_next_raw_format \
    ...
    --mm_min_image_token 182\
    --mm_max_image_token 182\
    ...
    2>&1 | tee /mnt/petrelfs/niujunbo/zhengyuanhong/NativeResLLaVA/logs/direct_finetune_qwen_a4_next_182_182.log'
