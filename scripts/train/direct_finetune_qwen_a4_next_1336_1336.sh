...
export MID_RUN_NAME="llava-next-Qwen2-7B-Instruct-qwenvit-1336_1336_visual_token-ft_v2"
export PROMPT_VERSION="qwen_1_5"

export BASE_RUN_NAME="llavanext-${VISION_MODEL_VERSION_CLEAN}-${LLM_VERSION_CLEAN}-mlp2x_gelu-pretrain_blip558k_plain_1336"
...
srun -J debug \
    ...
    2>&1 | tee /mnt/petrelfs/niujunbo/zhengyuanhong/NativeResLLaVA/logs/direct_finetune_qwen_a4_next_1336_1336.log'
