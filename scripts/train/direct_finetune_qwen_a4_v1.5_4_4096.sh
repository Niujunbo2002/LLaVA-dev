...
export MID_RUN_NAME="llava-next-Qwen2-7B-Instruct-qwenvit-${MIN_TOKEN}_${MAX_TOKEN}_visual_token-ft_2"
...
srun -J debug \
    ...
    --mm_min_image_token ${MIN_TOKEN}\
    --mm_max_image_token ${MAX_TOKEN}\
    ...
    2>&1 | tee /mnt/petrelfs/niujunbo/zhengyuanhong/NativeResLLaVA/logs/nativeres-llava-next_v1.5_${MIN_TOKEN}_${MAX_TOKEN}.log'
