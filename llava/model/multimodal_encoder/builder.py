...
from .qwen_vit import Qwen2VisionTransformerPretrainedModelForLLaVA
from .qwen2_5_vit import Qwen2_5_VisionTransformerPretrainedModelForLLaVA
...
def build_vision_tower(vision_tower_cfg, **kwargs):
    ...
    elif "qwen2.5" in vision_tower.split('/')[-1].lower():
        print("Qwen2.5")
